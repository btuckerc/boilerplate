...
function M.apply(transparent)
  ...
  vim.cmd(
    "highlight StatusLine guifg="
      .. colors.foreground
      .. " guibg="
      .. (transparent and "NONE" or colors.active_tab_background)
  )
  vim.cmd(
    "highlight StatusLineNC guifg="
      .. colors.inactive_tab_foreground
      .. " guibg="
      .. (transparent and "NONE" or colors.inactive_tab_background)
  )

  -- Floating windows
  vim.cmd("highlight NormalFloat guifg=" .. colors.foreground .. " guibg=" .. (transparent and "NONE" or colors.color0))
  vim.cmd(
    "highlight FloatBorder guifg=" .. colors.tab_border_color .. " guibg=" .. (transparent and "NONE" or colors.color0)
  )
